...
static const unsigned char PROGMEM blob_bmp3[6][392] = { {
                                                           0x00,
                                                           0x00,
                                                           0x00,
                                                           0x00,
...
void loop() {
  ...
  if (!running && currentMillis - startMillis >= runningDelay) {
    runningDelay = 4000;
  ...
  if (currentMillisBlob - startMillisBlob >= periodBlob) {
    ...
    if (state == 3) {
      display.drawBitmap(
        oldPosition[0],
        oldPosition[1],
        blob_bmp3[k], BLOB_WIDTH, BLOB_HEIGHT, 1);
    }
    else if (state == 2) {
      display.drawBitmap(
        oldPosition[0],
